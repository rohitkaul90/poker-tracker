...
android {
    ...
    buildTypes {
        release {
            // Uses release signing in CI (tablelab-release.jks decoded from secret).
            // Falls back to debug signing for local builds without the keystore.
            signingConfig = if (file("tablelab-release.jks").exists()) {
